Plan is to have a personal project where i will try to make a Website with Flask
where i can play around and hopefully show of some projects.
When i find the time and energy
